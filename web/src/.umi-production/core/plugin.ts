...
import * as Plugin_0 from '/root/sean/workspace/.lighthouse/lighthouse-src/web/src/app.tsx';
  ...
  return [
    {
      ...
      path: process.env.NODE_ENV === 'production' ? void 0 : '/root/sean/workspace/.lighthouse/lighthouse-src/web/src/app.tsx',
    },
    {
      apply: Plugin_1,
